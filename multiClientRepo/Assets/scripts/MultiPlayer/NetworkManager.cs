...
public class NetworkManager : MonoBehaviour
{
    ...
    [SerializeField] private InputField inputPort,inputIp,inputName,inputTeam;
    ...
    private void Start(){
        ...
        inputName.text = PlayerPrefs.GetString("localMainPlayerName");
        inputTeam.text = PlayerPrefs.GetString("localMainPlayerTeam");
    ...
    public void Connect(){
        PlayerPrefs.SetString("localMainPlayerName", inputName.text);
        PlayerPrefs.SetString("localMainPlayerName", inputTeam.text);
        if (inputIp.text != "")
        {
            ip = inputIp.text;
            Debug.Log("textIp");
